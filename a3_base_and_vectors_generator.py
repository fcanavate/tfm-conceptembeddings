...
import a2_parser_ufaludpipe.py
import numpy as np
...
def reconocimiento_entidades (index_nombre,analisis2):
    entidad=""
    for palabra2 in analisis2:
            #print ("palabra1:",palabra1)
        if len(palabra2)>6:             
            if palabra1[6]==indexnombre and (palabra1[3]=="NOUN" or palabra1[3]=="PROPN") and palabra1[7]=="nsubj":
...
def parsergeneral(texto):
    ...
    for sentence in sentences:
        ...
        #llamada al parse
        #print(sentence3)
        analisis=a2_parser_ufaludpipe.parse(sentence3)
...
# creo que no hace falta lo anterior. siplemnte al definirla con indices duplciados los suma. ver otros metodos ttps://docs.scipy.org/doc/scipy/reference/generated/scipy.sparse.coo_matrix.html
