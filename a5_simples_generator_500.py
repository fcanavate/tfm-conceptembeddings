...
base_verb_500.to_csv("base_verb_500.csv",index=False)
headers_vectores=base_verb_500["index_verb"]
headers_vectores_matrix=headers_vectores.transpose().to_numpy()
vectores=vectores.loc[:, headers_vectores_matrix]
vectores.to_csv("coord_nounsuj_verb_500_densa.csv",index=False)
nombres_vectores_pd.to_csv("base_noun_500.csv",index=False,encoding="utf_8_sig")
