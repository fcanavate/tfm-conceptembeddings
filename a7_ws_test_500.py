...
base_verb_pd=pd.read_csv("base_verb_500.csv",header=0,names=['index_verb','verbostd','verbo'])
base_verb_pd.index = np.arange(1, len(base_verb_pd)+1)
base_noun_pd=pd.read_csv("base_noun_500.csv",header=0,names=['index_noun','nombrestd'])
base_noun_pd.index = np.arange(1, len(base_noun_pd)+1)
coord_nounsuj_verb_pd=pd.read_csv("coord_nounsuj_verb_500_densa.csv")
...
base_noun_distancias_pd.to_csv("base_noun_pd_distancias_500.csv",encoding="utf_8_sig")
